...
#ifndef AlashIRControlRX_h
#define AlashIRControlRX_h
...
class AlashIRControlRX{
	public:			AlashIRControlRX					(uint8_t, bool=true);			//	подключение 						(№ вывода подключённого к ИК-приемнику, инверсия сигнала с ИК-приёмника)
